...
**Primary Notice:**
이 글에서는 프레임워크를 사용하지 않고, 순수 자바스크립트만으로 라우팅 기능을 어떻게 구현했는지 그 과정을 기록하고자 한다. 내용에 틀린 내용이 있을 수 있으니 양해 부탁드립니다!
{: .notice--primary}
...
# 회고
이번 포스팅을 통해서 프레임워크 없이 애플리케이션 개발은 생각해본 적 없던 나에게 기능들이 어떻게 작동되고 있는지를 파악할 수 있도록 해준 실습이었다. 
